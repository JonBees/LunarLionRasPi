/*
** $Id: sch_def_msgtbl.c 1.4 2012/07/20 17:09:19EDT aschoeni Exp  $
**
...
/*{ { CFE_MAKE_BIG16(MD_WAKEUP_MID),            CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } }, */
  ...
  */
  ...
  { { CFE_MAKE_BIG16(TO_SEND_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #32 - SI Read Data*/
  { { CFE_MAKE_BIG16(SI_RX_MID),   CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #33 - SI Transmit Data*/
  { { CFE_MAKE_BIG16(SI_TX_MID),   CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } },
    /* command ID #34 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },  
    /* command ID #35 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
